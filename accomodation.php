...
<html lang="">
	<head>
		...
		<title>Metro train Reservation</title>
	...
	<body style="background:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(train.jpg); background-repeat:no-repeat; background-size:cover;  ">
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" >Online Ticketing</a>
    </div>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">1. SCHEDULE OF TRAVEL
								</h3>
							</div>
							<div class="panel-body">
...
<p align=center><img src="map.jpg" length=30% width=30%></p>
<div class="container-fluid">
