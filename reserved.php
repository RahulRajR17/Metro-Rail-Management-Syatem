...
<html lang="">
	<head>
		...
		<title>Metro train Rerservation</title>
...
<body style="background:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(green.jpg); background-repeat:no-repeat; background-size:cover;  ">
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="panel panel-info">
							<div class="panel-heading">
								<h3 class="panel-title">2.ROUTE</h3>
							</div>
							<div class="panel-body">
								Route TYPE
							</div>
...
<div class="container-fluid">
	...
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-body">
			 <h2>
			 	<center>SCHEDULE OF TRAVEL</center>
			 </h2>
				<div class="container-fluid">
